 ...
 * transition.
 */
public class CarLauncherDisplayAreaTransactionHelper {
    private static final String TAG = "CarLauncherDisplayAreaTransactionHelper";

    private final boolean mEnableCornerRadius;
    private final float mCornerRadius;
    private final float mCornerRadiusAdjustment;

    public CarLauncherDisplayAreaTransactionHelper(Context context) {
     ...
     *
     * @return same {@link CarLauncherDisplayAreaTransactionHelper}
     * instance for method chaining
     */
    CarLauncherDisplayAreaTransactionHelper translate(
     ...
     * instance for method chaining
     */
    CarLauncherDisplayAreaTransactionHelper crop(
            SurfaceControl.Transaction tx, SurfaceControl leash,
     ...
     * instance for method chaining
     */
    CarLauncherDisplayAreaTransactionHelper round(
            SurfaceControl.Transaction tx, SurfaceControl leash) {
